      ...
      actions: enqueueActions(({ enqueue, event }) => {
        ...
        if (isKnownError(event.error)) {
          ...
          for (const error of event.error.errors || [event.error]) {
            const name = snakeToCamel((_a3 = error.meta) == null ? void 0 : _a3.paramName);
            if (!name) {
...
import { useClerk as useClerk2 } from "@clerk/clerk-react";
...
import { useClerk as useClerk3 } from "@clerk/clerk-react";
...
import { useClerk as useClerk6 } from "@clerk/clerk-react";
...
import { useClerk as useClerk4 } from "@clerk/clerk-react";
...
function SignInChooseSession({ children, ...props }) {
  ...
  return activeState ? /* @__PURE__ */ jsx8(SignInChooseSessionCtx.Provider, { children: /* @__PURE__ */ jsx8("div", { ...props, children }) }) : null;
}
...
import { assign as assign2, fromPromise, log, sendTo, setup as setup2 } from "xstate";
    ...
    validateRegisteredStrategies: ({ context }) => {
      ...
      if (false) {
        ...
        const strategiesUsedButNotActivated = Array.from(context.registeredStrategies).filter(
          (strategy) => !((_a4 = clerk.client.signIn.supportedFirstFactors) == null ? void 0 : _a4.some((supported) => supported.strategy === strategy))
        );
        ...
        if (((_b3 = context.currentFactor) == null ? void 0 : _b3.strategy) && !context.registeredStrategies.has((_c = context.currentFactor) == null ? void 0 : _c.strategy)) {
          throw new ClerkElementsRuntimeError(
...
import { and, assign as assign4, enqueueActions as enqueueActions2, fromPromise as fromPromise5, log as log3, not as not3, or, raise, sendTo as sendTo5, setup as setup6 } from "xstate";
...
import { assertEvent, assign as assign3, log as log2, not, sendTo as sendTo2, setup as setup3 } from "xstate";
...
import { assertEvent as assertEvent2, fromPromise as fromPromise4, not as not2, sendTo as sendTo4, setup as setup5 } from "xstate";
...
var SignInRouterMachine = setup6({
  ...
  guards: {
    ...
    isLoggedInAndSingleSession: and(["isLoggedIn", "isSingleSessionMode", not3("isExampleMode")]),
    ...
    needsStart: or([not3("hasResource"), "statusNeedsIdentifier", isCurrentPath("/")]),
...
function SignInChooseStrategy({ children, ...props }) {
  ...
  return activeState ? /* @__PURE__ */ jsx9(SignInChooseStrategyCtx.Provider, { children: /* @__PURE__ */ jsx9("div", { ...props, children }) }) : null;
}
...
function SignInStep(props) {
  ...
  (_a3 = clerk.telemetry) == null ? void 0 : _a3.record(eventComponentMounted2("Elements_SignInStep", { name: props.name }));
  switch (props.name) {
...
import { useClerk as useClerk5 } from "@clerk/clerk-react";
...
function SignUpStep(props) {
  ...
  (_a3 = clerk.telemetry) == null ? void 0 : _a3.record(eventComponentMounted3("Elements_SignUpStep", { name: props.name }));
  switch (props.name) {
...
function Loading({ children, scope }) {
  ...
  (_a3 = clerk.telemetry) == null ? void 0 : _a3.record(eventComponentMounted4("Elements_Loading", { scope: scope != null ? scope : false }));
  const signInRouterRef = SignInRouterCtx.useActorRef(true);
...
//# sourceMappingURL=chunk-BXZUXUGF.mjs.map