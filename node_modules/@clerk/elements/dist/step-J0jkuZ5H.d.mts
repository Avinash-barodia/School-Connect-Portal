...
import { ActiveSessionResource, PublicUserData, SignInFactor, SignInStrategy as SignInStrategy$1 } from '@clerk/types';
import { a as FormProps } from './submit-gXm55DfO.mjs';

type SignInActiveSessionListItem = Pick<ActiveSessionResource, 'id'> & PublicUserData;

type SignInChooseSessionProps = React$1.HTMLAttributes<HTMLDivElement>;
type SignInSessionListProps = React$1.HTMLAttributes<HTMLUListElement> & {
    asChild?: boolean;
    includeCurrentSession?: true;
};
type SignInSessionListItemProps = Omit<React$1.HTMLAttributes<HTMLLIElement>, 'children'> & {
    asChild?: boolean;
    children: ({ session }: {
        session: SignInActiveSessionListItem;
    }) => React$1.ReactNode;
};
declare function SignInSessionList({ asChild, children, includeCurrentSession, ...props }: SignInSessionListProps): react_jsx_runtime.JSX.Element | null;
declare function SignInSessionListItem(props: SignInSessionListItemProps): react_jsx_runtime.JSX.Element;
...
declare const SIGN_IN_STEPS: {
    ...
    readonly 'choose-session': "choose-session";
...
type SignInStepProps = StepWithProps<'start', SignInStartProps> | StepWithProps<'verifications', SignInVerificationsProps> | StepWithProps<'choose-strategy' | 'forgot-password', SignInChooseStrategyProps> | StepWithProps<'reset-password', SignInResetPasswordProps> | StepWithProps<'choose-session', SignInChooseSessionProps>;
/**
...
export { SignInStep as S, type TSignInStep as T, SignInSupportedStrategy as a, SignInSessionList as b, SignInSessionListItem as c, SignInFirstFactor as d, SignInSecondFactor as e, SignInStrategy as f };
