...
function SignInFlowProvider({ children, exampleMode, fallback, isRootPath }) {
  ...
  const isReady = (0, import_react8.useSelector)(actor, (state) => state.value !== "Idle");
...
function useActiveTags(actor2, tags, mode = ActiveTagsMode.any) {
  const state = (0, import_react10.useSelector)(
    actor2,
    (s) => s,
...
function SignInChooseSession({ children, ...props }) {
  ...
  return activeState ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(SignInChooseSessionCtx.Provider, { children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { ...props, children }) }) : null;
}
...
function SignInChooseStrategy({ children, ...props }) {
  ...
  return activeState ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(SignInChooseStrategyCtx.Provider, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { ...props, children }) }) : null;
}
...
var SignInSupportedStrategy = React9.forwardRef(
  ({ asChild, children, name, ...rest }, forwardedRef) => {
    ...
    const currentFactor = (0, import_react11.useSelector)(
...
function SignInStrategiesProvider({
  ...
  const routerRef = SignInRouterCtx.useActorRef();
  const current = (0, import_react12.useSelector)(actorRef, strategiesSelector);
  const isChoosingAltStrategy = useActiveTags(routerRef, ["step:choose-strategy", "step:forgot-password"]);
  const isActive = (0, import_react13.useCallback)((name) => current ? matchStrategy(current, name) : false, [current]);
...
function SignInStep(props) {
  ...
  (_a3 = clerk.telemetry) == null ? void 0 : _a3.record((0, import_telemetry2.eventComponentMounted)("Elements_SignInStep", { name: props.name }));
  switch (props.name) {
...
var import_react14 = require("@xstate/react");
...
var SignInResend = React11.forwardRef(
  ({ asChild, fallback, ...rest }, forwardedRef) => {
    ...
    const fallbackProps = (0, import_react14.useSelector)(
      actorRef,
      (state) => ({
...
function SignInSafeIdentifier({ transform }) {
  ...
  const selector = (0, import_react15.useMemo)(() => SignInSafeIdentifierSelectorForStrategy(strategy), [strategy]);
