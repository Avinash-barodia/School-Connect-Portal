...
var SignUpVerificationMachine = (0, import_xstate6.setup)({
  ...
  guards: {
    ...
    isStrategyEnabled: ({ context }, { attribute, strategy }) => {
      var _a3;
      return Boolean((_a3 = context.attributes) == null ? void 0 : _a3[attribute].verifications.includes(strategy));
    },
...
var SignUpRouterMachine = (0, import_xstate7.setup)({
  ...
  actions: {
    ...
    setActive: ({ context, event }, params) => {
      ...
      const beforeEmit = () => {
        var _a3, _b3;
        return (_b3 = context.router) == null ? void 0 : _b3.push(((_a3 = context.router) == null ? void 0 : _a3.searchParams().get("redirect_url")) || context.clerk.buildAfterSignUpUrl());
      };
    ...
    "AUTHENTICATE.SAML": {
      actions: (0, import_xstate7.sendTo)(ThirdPartyMachineId, ({ context }) => {
        ...
        return {
          ...
          params: {
            strategy: "saml",
            emailAddress: (_a3 = context.formRef.getSnapshot().context.fields.get("emailAddress")) == null ? void 0 : _a3.value,
            redirectUrl: `${((_b3 = context.router) == null ? void 0 : _b3.mode) === ROUTING.virtual ? (_c = context.clerk.__unstable__environment) == null ? void 0 : _c.displayConfig.signUpUrl : (_d = context.router) == null ? void 0 : _d.basePath}${SSO_CALLBACK_PATH_ROUTE}`,
    ...
    Idle: {
      on: {
        INIT: {
          actions: (0, import_xstate7.assign)(({ event }) => {
            var _a3;
            const searchParams = (_a3 = event.router) == null ? void 0 : _a3.searchParams();
            return {
              clerk: event.clerk,
              router: event.router,
          ...
          actions: [
            (0, import_xstate7.log)("Already logged in"),
            {
              ...
              params: ({ context }) => {
                var _a3;
                return {
                  path: ((_a3 = context.router) == null ? void 0 : _a3.searchParams().get("redirect_url")) || context.clerk.buildAfterSignUpUrl()
                };
              }
            }
          ]
    ...
    Verification: {
      ...
      invoke: {
        ...
        input: ({ context, self }) => {
          var _a3, _b3;
          return {
            attributes: (_a3 = context.clerk.__unstable__environment) == null ? void 0 : _a3.userSettings.attributes,
            basePath: (_b3 = context.router) == null ? void 0 : _b3.basePath,
            formRef: context.formRef,
            parent: self,
...
function SignUpFlowProvider({ children, exampleMode, fallback, isRootPath }) {
  ...
  const isReady = (0, import_react6.useSelector)(actor, (state) => state.value !== "Idle");
...
function useActiveTags(actor2, tags, mode = ActiveTagsMode.any) {
  const state = (0, import_react8.useSelector)(
    actor2,
    (s) => s,
...
function SignUpStep(props) {
  ...
  (_a3 = clerk.telemetry) == null ? void 0 : _a3.record((0, import_telemetry2.eventComponentMounted)("Elements_SignUpStep", { name: props.name }));
  switch (props.name) {
...
var SignUpResend = React5.forwardRef(
  ({ asChild, fallback, ...rest }, forwardedRef) => {
    ...
    const fallbackProps = (0, import_react9.useSelector)(
      ref,
      (state) => ({
